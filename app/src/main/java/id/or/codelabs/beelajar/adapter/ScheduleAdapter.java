 ...
 */
public class ScheduleAdapter extends RecyclerView.Adapter<ScheduleAdapter.JadwalView> {

    private ArrayList<ModelJadwal> arrayJadwal;
    private Context context;

    public ScheduleAdapter(ArrayList<ModelJadwal> arrayJadwal, Context context) {
